...
//--- 变量区
  ...
  Future checkNewVersion(context,pattern) async {
    ...
    var downLoadUrl = 'http://zhwk.wfust.edu.cn/apk/android1.json';
...
********************************************************************************
                                列表模式
********************************************************************************
      //执行方法 checkNewVersion(context,值)
      checkNewVersion(context,pattern)

      ps:如果值是'dong'，为弹框式提示，非'dong'的任意字符串为 设置模块 - 有版本提示 样式
